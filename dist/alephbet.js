...
Adapters = function () {
  ...
  Adapters.LamedAdapter = function () {
    var LamedAdapter = /*#__PURE__*/function (_Adapters$GimelAdapte) {
      _inherits(LamedAdapter, _Adapters$GimelAdapte);
